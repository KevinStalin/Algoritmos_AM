...
# VARIABLES DEPENDIENTES
X = data[['alcohol', 'malic_acid', 'ash', 'alcalinity_of_ash', 'magnesium', 'total_phenols', 'flavanoids',
...
matrizConfusion2 = metrics.confusion_matrix(y_test, y_pred2)
precision2 = metrics.precision_score(y_test, y_pred2, average=None)
accuracy2 = metrics.accuracy_score(y_test, y_pred2)
recall2 = metrics.recall_score(y_test, y_pred2, average=None)
f12 = metrics.f1_score(y_test, y_pred2, average=None)

print("Matriz de Confusion: \n", metrics.confusion_matrix(y_test, y_pred2))
print("PrecisiÃ³n: ", metrics.precision_score(y_test, y_pred2, average=None))
print("Accuracy:", metrics.accuracy_score(y_test, y_pred2))
print("Recall: ", metrics.recall_score(y_test, y_pred2, average=None))
print("F1: ", metrics.f1_score(y_test, y_pred2, average=None))
